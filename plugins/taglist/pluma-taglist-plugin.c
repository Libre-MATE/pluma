...
G_DEFINE_DYNAMIC_TYPE_EXTENDED(
    PlumaTaglistPlugin, pluma_taglist_plugin, PEAS_TYPE_EXTENSION_BASE, 0,
...
static void pluma_taglist_plugin_init(PlumaTaglistPlugin *plugin) {
...
static void pluma_taglist_plugin_dispose(GObject *object) {
...
static void pluma_taglist_plugin_finalize(GObject *object) {
...
static void pluma_taglist_plugin_activate(PlumaWindowActivatable *activatable) {
  ...
  pluma_panel_add_item_with_icon(side_panel, priv->taglist_panel, _("Tags"),
                                 "list-add");
}

static void pluma_taglist_plugin_deactivate(
  ...
  pluma_panel_remove_item(side_panel, priv->taglist_panel);
}

static void pluma_taglist_plugin_update_state(
    PlumaWindowActivatable *activatable) {
  PlumaTaglistPluginPrivate *priv;
  PlumaWindow *window;
  PlumaView *view;
...
static void pluma_taglist_plugin_set_property(GObject *object, guint prop_id,
                                              const GValue *value,
                                              GParamSpec *pspec) {
  PlumaTaglistPlugin *plugin = PLUMA_TAGLIST_PLUGIN(object);
...
static void pluma_taglist_plugin_get_property(GObject *object, guint prop_id,
                                              GValue *value,
                                              GParamSpec *pspec) {
  PlumaTaglistPlugin *plugin = PLUMA_TAGLIST_PLUGIN(object);
...
static void pluma_taglist_plugin_class_init(PlumaTaglistPluginClass *klass) {
...
static void pluma_taglist_plugin_class_finalize(
    PlumaTaglistPluginClass *klass) {
...
G_MODULE_EXPORT void peas_register_types(PeasObjectModule *module) {
  ...
  peas_object_module_register_extension_type(
      module, PLUMA_TYPE_WINDOW_ACTIVATABLE, PLUMA_TYPE_TAGLIST_PLUGIN);
}
