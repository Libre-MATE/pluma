...
#define PLUMA_SPELL_CHECKER(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_SPELL_CHECKER, \
                              PlumaSpellChecker))
#define PLUMA_SPELL_CHECKER_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), PLUMA_TYPE_SPELL_CHECKER, \
                           PlumaSpellChecker))
#define PLUMA_IS_SPELL_CHECKER(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), PLUMA_TYPE_SPELL_CHECKER))
#define PLUMA_IS_SPELL_CHECKER_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), PLUMA_TYPE_SPELL_CHECKER))
#define PLUMA_SPELL_CHECKER_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), PLUMA_TYPE_SPELL_CHECKER, \
                             PlumaSpellChecker))
...
struct _PlumaSpellCheckerClass {
  ...
  /* Signals */
  void (*add_word_to_personal)(PlumaSpellChecker *spell, const gchar *word,
                               gint len);

  void (*add_word_to_session)(PlumaSpellChecker *spell, const gchar *word,
                              gint len);
...
gboolean pluma_spell_checker_set_language(
    PlumaSpellChecker *spell, const PlumaSpellCheckerLanguage *lang);
