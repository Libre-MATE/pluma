...
#define PLUMA_FILE_BROWSER_STORE(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_FILE_BROWSER_STORE, \
                              PlumaFileBrowserStore))
#define PLUMA_FILE_BROWSER_STORE_CONST(obj)                         \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_FILE_BROWSER_STORE, \
                              PlumaFileBrowserStore const))
#define PLUMA_FILE_BROWSER_STORE_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), PLUMA_TYPE_FILE_BROWSER_STORE, \
                           PlumaFileBrowserStoreClass))
#define PLUMA_IS_FILE_BROWSER_STORE(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), PLUMA_TYPE_FILE_BROWSER_STORE))
#define PLUMA_IS_FILE_BROWSER_STORE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), PLUMA_TYPE_FILE_BROWSER_STORE))
#define PLUMA_FILE_BROWSER_STORE_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), PLUMA_TYPE_FILE_BROWSER_STORE, \
                             PlumaFileBrowserStoreClass))
...
#define FILE_IS_FILTERED(flags) \
  (flags & PLUMA_FILE_BROWSER_STORE_FLAG_IS_FILTERED)
...
typedef gboolean (*PlumaFileBrowserStoreFilterFunc)(
    PlumaFileBrowserStore *model, GtkTreeIter *iter, gpointer user_data);
...
struct _PlumaFileBrowserStoreClass {
  ...
  /* Signals */
  void (*begin_loading)(PlumaFileBrowserStore *model, GtkTreeIter *iter);
  void (*end_loading)(PlumaFileBrowserStore *model, GtkTreeIter *iter);
  void (*error)(PlumaFileBrowserStore *model, guint code, gchar *message);
  gboolean (*no_trash)(PlumaFileBrowserStore *model, GList *files);
  void (*rename)(PlumaFileBrowserStore *model, const gchar *olduri,
                 const gchar *newuri);
  void (*begin_refresh)(PlumaFileBrowserStore *model);
  void (*end_refresh)(PlumaFileBrowserStore *model);
  void (*unload)(PlumaFileBrowserStore *model, const gchar *uri);
};
...
PlumaFileBrowserStoreResult pluma_file_browser_store_set_root_and_virtual_root(
    PlumaFileBrowserStore *model, gchar const *root, gchar const *virtual_root);
...
gboolean pluma_file_browser_store_rename(PlumaFileBrowserStore *model,
                                         GtkTreeIter *iter,
                                         gchar const *new_name, GError **error);
