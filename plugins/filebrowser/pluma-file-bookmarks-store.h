...
#define PLUMA_FILE_BOOKMARKS_STORE(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_FILE_BOOKMARKS_STORE, \
                              PlumaFileBookmarksStore))
#define PLUMA_FILE_BOOKMARKS_STORE_CONST(obj)                         \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_FILE_BOOKMARKS_STORE, \
                              PlumaFileBookmarksStore const))
#define PLUMA_FILE_BOOKMARKS_STORE_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), PLUMA_TYPE_FILE_BOOKMARKS_STORE, \
                           PlumaFileBookmarksStoreClass))
#define PLUMA_IS_FILE_BOOKMARKS_STORE(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), PLUMA_TYPE_FILE_BOOKMARKS_STORE))
#define PLUMA_IS_FILE_BOOKMARKS_STORE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), PLUMA_TYPE_FILE_BOOKMARKS_STORE))
#define PLUMA_FILE_BOOKMARKS_STORE_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), PLUMA_TYPE_FILE_BOOKMARKS_STORE, \
                             PlumaFileBookmarksStoreClass))
...
enum {
  ...
  PLUMA_FILE_BOOKMARKS_STORE_IS_HOME =
      1 << 2, /* The special Home user directory */
  PLUMA_FILE_BOOKMARKS_STORE_IS_DESKTOP =
      1 << 3, /* The special Desktop user directory */
  PLUMA_FILE_BOOKMARKS_STORE_IS_DOCUMENTS =
      1 << 4, /* The special Documents user directory */
  ...
  PLUMA_FILE_BOOKMARKS_STORE_IS_ROOT =
      1 << 9, /* The root file system (file:///) */
  PLUMA_FILE_BOOKMARKS_STORE_IS_BOOKMARK = 1 << 10, /* A gtk bookmark */
  PLUMA_FILE_BOOKMARKS_STORE_IS_REMOTE_BOOKMARK =
      1 << 11, /* A remote gtk bookmark */
  PLUMA_FILE_BOOKMARKS_STORE_IS_LOCAL_BOOKMARK =
      1 << 12 /* A local gtk bookmark */
};
