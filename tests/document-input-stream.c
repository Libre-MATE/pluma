...
static void test_consecutive_read(const gchar *inbuf, const gchar *outbuf,
...
static void test_consecutive_cut_char() {
...
static void test_consecutive_big_read() {
  test_consecutive_read("\nfo\nbar\n\nblah\n", "\rfo\rbar\r\rblah\r\r",
                        PLUMA_DOCUMENT_NEWLINE_TYPE_CR, 200);
  test_consecutive_read("\nfo\nbar\n\nblah", "\rfo\rbar\r\rblah\r",
                        PLUMA_DOCUMENT_NEWLINE_TYPE_CR, 200);
...
static void test_consecutive_middle_read() {
  test_consecutive_read("\nfo\nbar\n\nblah\n", "\rfo\rbar\r\rblah\r\r",
                        PLUMA_DOCUMENT_NEWLINE_TYPE_CR, 6);
  test_consecutive_read("\nfo\nbar\n\nblah", "\rfo\rbar\r\rblah\r",
                        PLUMA_DOCUMENT_NEWLINE_TYPE_CR, 6);
...
static void test_consecutive_multibyte_cut() {
  test_consecutive_read("hello\nhello\xe6\x96\x87\nworld\n",
                        "hello\rhello\xe6\x96\x87\rworld\r\r",
                        PLUMA_DOCUMENT_NEWLINE_TYPE_CR, 6);
  test_consecutive_read("hello\rhello\xe6\x96\x87\rworld\r",
                        "hello\rhello\xe6\x96\x87\rworld\r\r",
                        PLUMA_DOCUMENT_NEWLINE_TYPE_CR, 6);
  test_consecutive_read("hello\nhello\xe6\x96\x87\nworld\n",
                        "hello\nhello\xe6\x96\x87\nworld\n\n",
...
static void test_consecutive_multibyte_big_read() {
  test_consecutive_read("hello\nhello\xe6\x96\x87\nworld\n",
                        "hello\rhello\xe6\x96\x87\rworld\r\r",
                        PLUMA_DOCUMENT_NEWLINE_TYPE_CR, 200);
  test_consecutive_read("hello\rhello\xe6\x96\x87\rworld\r",
...
int main(int argc, char *argv[]) {
  ...
  g_test_add_func("/document-input-stream/consecutive_cut_char",
                  test_consecutive_cut_char);
  g_test_add_func("/document-input-stream/consecutive_big_read",
                  test_consecutive_big_read);
  g_test_add_func("/document-input-stream/consecutive_middle_read",
                  test_consecutive_middle_read);

  g_test_add_func("/document-input-stream/consecutive_multibyte_cut",
                  test_consecutive_multibyte_cut);
  g_test_add_func("/document-input-stream/consecutive_multibyte_big_read",
