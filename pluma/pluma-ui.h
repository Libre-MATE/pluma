...
static const GtkActionEntry pluma_always_sensitive_menu_entries[] = {
    ...
    /* Fullscreen toolbar */
    {"LeaveFullscreen", "view-restore", N_("_Leave Fullscreen"), NULL,
...
static const GtkActionEntry pluma_menu_entries[] = {
    ...
    {"FileSaveAs", "document-save-as", N_("Save _As..."), "<shift><control>S",
     ...
     G_CALLBACK(_pluma_cmd_file_save_as)},
    {"FileRevert", "document-revert", N_("_Revert"), NULL,
     N_("Revert to a saved version of the file"),
     G_CALLBACK(_pluma_cmd_file_revert)},
    {"FilePrintPreview", "document-print-preview", N_("Print Previe_w"),
     "<control><shift>P", N_("Print preview"),
     G_CALLBACK(_pluma_cmd_file_print_preview)},
    ...
    {"EditCut", "edit-cut", N_("Cu_t"), "<control>X", N_("Cut the selection"),
     G_CALLBACK(_pluma_cmd_edit_cut)},
    ...
    {"SearchClearHighlight", NULL, N_("_Clear Highlight"), "<shift><control>K",
     N_("Clear highlighting of search matches"),
     G_CALLBACK(_pluma_cmd_search_clear_highlight)},
    {"SearchGoToLine", "go-jump", N_("Go to _Line..."), "<control>I",
     N_("Go to a specific line"), G_CALLBACK(_pluma_cmd_search_goto_line)},
    {"SearchIncrementalSearch", "edit-find", N_("_Incremental Search..."),
     "<control>K", N_("Incrementally search for text"),
     G_CALLBACK(_pluma_cmd_search_incremental_search)},
    ...
    {"DocumentsPreviousDocument", NULL, N_("_Previous Document"),
     "<alt><control>Page_Up", N_("Activate previous document"),
     G_CALLBACK(_pluma_cmd_documents_previous_document)},
    {"DocumentsNextDocument", NULL, N_("_Next Document"),
     "<alt><control>Page_Down", N_("Activate next document"),
     G_CALLBACK(_pluma_cmd_documents_next_document)},
    {"DocumentsMoveToNewWindow", NULL, N_("_Move to New Window"), NULL,
     N_("Move the current document to a new window"),
     G_CALLBACK(_pluma_cmd_documents_move_to_new_window)}};
