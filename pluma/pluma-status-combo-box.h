...
#define PLUMA_STATUS_COMBO_BOX(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_STATUS_COMBO_BOX, \
                              PlumaStatusComboBox))
#define PLUMA_STATUS_COMBO_BOX_CONST(obj)                         \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_STATUS_COMBO_BOX, \
                              PlumaStatusComboBox const))
#define PLUMA_STATUS_COMBO_BOX_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), PLUMA_TYPE_STATUS_COMBO_BOX, \
                           PlumaStatusComboBoxClass))
#define PLUMA_IS_STATUS_COMBO_BOX(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), PLUMA_TYPE_STATUS_COMBO_BOX))
#define PLUMA_IS_STATUS_COMBO_BOX_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), PLUMA_TYPE_STATUS_COMBO_BOX))
#define PLUMA_STATUS_COMBO_BOX_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), PLUMA_TYPE_STATUS_COMBO_BOX, \
                             PlumaStatusComboBoxClass))
...
struct _PlumaStatusComboBoxClass {
  ...
  void (*changed)(PlumaStatusComboBox *combo, GtkMenuItem *item);
};
