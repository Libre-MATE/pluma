...
void _pluma_cmd_help_about(GtkAction *action, PlumaWindow *window) {
  static const gchar *documenters[] = {N_("MATE Documentation Team"),
                                       N_("GNOME Documentation Team"),
                                       N_("Sun Microsystems"), NULL};
  ...
  static const gchar *license[] = {
      ...
      N_("You should have received a copy of the GNU General Public License "
         "along with Pluma; if not, write to the Free Software Foundation, "
         "Inc., "
  ...
  if (!g_key_file_load_from_file(
          key_file, PLUMA_DATADIR G_DIR_SEPARATOR_S "pluma.about", 0, &error)) {
  ...
  gtk_show_about_dialog(
      GTK_WINDOW(window), "program-name", "Pluma", "title", _("About Pluma"),
      "authors", authors, "comments", _(comments), "copyright",
      _("Copyright \xc2\xa9 1998-2000 Evan Lawrence, Alex Robert\n"
        "Copyright \xc2\xa9 2000-2002 Chema Celorio, Paolo Maggi\n"
        "Copyright \xc2\xa9 2003-2006 Paolo Maggi\n"
        "Copyright \xc2\xa9 2004-2010 Paolo Borelli, Jesse van den "
        "Kieboom\nSteve Fr\303\251cinaux, Ignacio Casal Quinteiro\n"
        "Copyright \xc2\xa9 2011 Perberos\n"
        "Copyright \xc2\xa9 2012-2021 MATE developers"),
      "license", license_trans, "wrap-license", TRUE, "documenters",
      documenters, "logo_icon_name", "accessories-text-editor",
