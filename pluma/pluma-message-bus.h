...
#define PLUMA_MESSAGE_BUS(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_MESSAGE_BUS, PlumaMessageBus))
#define PLUMA_MESSAGE_BUS_CONST(obj)                         \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_MESSAGE_BUS, \
                              PlumaMessageBus const))
#define PLUMA_MESSAGE_BUS_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), PLUMA_TYPE_MESSAGE_BUS, \
                           PlumaMessageBusClass))
#define PLUMA_IS_MESSAGE_BUS(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), PLUMA_TYPE_MESSAGE_BUS))
#define PLUMA_IS_MESSAGE_BUS_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), PLUMA_TYPE_MESSAGE_BUS))
#define PLUMA_MESSAGE_BUS_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), PLUMA_TYPE_MESSAGE_BUS, \
                             PlumaMessageBusClass))
...
struct _PlumaMessageBusClass {
  ...
  void (*dispatch)(PlumaMessageBus *bus, PlumaMessage *message);
  void (*registered)(PlumaMessageBus *bus, PlumaMessageType *message_type);
  void (*unregistered)(PlumaMessageBus *bus, PlumaMessageType *message_type);
};

typedef void (*PlumaMessageCallback)(PlumaMessageBus *bus,
                                     PlumaMessage *message, gpointer userdata);
...
guint pluma_message_bus_connect(PlumaMessageBus *bus, const gchar *object_path,
                                ...
                                gpointer userdata, GDestroyNotify destroy_data);
...
void pluma_message_bus_send(PlumaMessageBus *bus, const gchar *object_path,
                            const gchar *method, ...) G_GNUC_NULL_TERMINATED;
