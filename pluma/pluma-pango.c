...
static void add_css_variations(GString *s, const char *variations) {
  const char *p;
  const char *sep = "";
 ...
 */
gchar *pluma_pango_font_description_to_css(const PangoFontDescription *desc) {
  GString *s;
  PangoFontMask set;
