...
#define PLUMA_WINDOW(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_WINDOW, PlumaWindow))
#define PLUMA_WINDOW_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), PLUMA_TYPE_WINDOW, PlumaWindowClass))
#define PLUMA_IS_WINDOW(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), PLUMA_TYPE_WINDOW))
#define PLUMA_IS_WINDOW_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), PLUMA_TYPE_WINDOW))
#define PLUMA_WINDOW_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), PLUMA_TYPE_WINDOW, PlumaWindowClass))
...
struct _PlumaWindowClass {
  ...
  /* Signals */
  void (*tab_added)(PlumaWindow *window, PlumaTab *tab);
  void (*tab_removed)(PlumaWindow *window, PlumaTab *tab);
  void (*tabs_reordered)(PlumaWindow *window);
  void (*active_tab_changed)(PlumaWindow *window, PlumaTab *tab);
  void (*active_tab_state_changed)(PlumaWindow *window);
};
