...
#define PLUMA_SETTINGS(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_SETTINGS, PlumaSettings))
#define PLUMA_SETTINGS_CONST(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_SETTINGS, PlumaSettings const))
#define PLUMA_SETTINGS_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), PLUMA_TYPE_SETTINGS, PlumaSettingsClass))
#define PLUMA_IS_SETTINGS(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), PLUMA_TYPE_SETTINGS))
#define PLUMA_IS_SETTINGS_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), PLUMA_TYPE_SETTINGS))
#define PLUMA_SETTINGS_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), PLUMA_TYPE_SETTINGS, PlumaSettingsClass))
...
GtkWrapMode pluma_settings_get_wrap_mode(GSettings *settings, const gchar *key);
