...
#define PLUMA_TYPE_CLOSE_CONFIRMATION_DIALOG \
  (pluma_close_confirmation_dialog_get_type())
#define PLUMA_CLOSE_CONFIRMATION_DIALOG(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_CLOSE_CONFIRMATION_DIALOG, \
                              PlumaCloseConfirmationDialog))
#define PLUMA_CLOSE_CONFIRMATION_DIALOG_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), PLUMA_TYPE_CLOSE_CONFIRMATION_DIALOG, \
                           PlumaCloseConfirmationDialogClass))
#define PLUMA_IS_CLOSE_CONFIRMATION_DIALOG(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), PLUMA_TYPE_CLOSE_CONFIRMATION_DIALOG))
#define PLUMA_IS_CLOSE_CONFIRMATION_DIALOG_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), PLUMA_TYPE_CLOSE_CONFIRMATION_DIALOG))
#define PLUMA_CLOSE_CONFIRMATION_DIALOG_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), PLUMA_TYPE_CLOSE_CONFIRMATION_DIALOG, \
                             PlumaCloseConfirmationDialogClass))

typedef struct _PlumaCloseConfirmationDialog PlumaCloseConfirmationDialog;
typedef struct _PlumaCloseConfirmationDialogClass
    PlumaCloseConfirmationDialogClass;
typedef struct _PlumaCloseConfirmationDialogPrivate
