...
#define PLUMA_MESSAGE(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_MESSAGE, PlumaMessage))
#define PLUMA_MESSAGE_CONST(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_MESSAGE, PlumaMessage const))
#define PLUMA_MESSAGE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), PLUMA_TYPE_MESSAGE, PlumaMessageClass))
#define PLUMA_IS_MESSAGE(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), PLUMA_TYPE_MESSAGE))
#define PLUMA_IS_MESSAGE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), PLUMA_TYPE_MESSAGE))
#define PLUMA_MESSAGE_GET_CLASS(obj) \
...
void pluma_message_get(PlumaMessage *message, ...) G_GNUC_NULL_TERMINATED;
...
void pluma_message_set(PlumaMessage *message, ...) G_GNUC_NULL_TERMINATED;
