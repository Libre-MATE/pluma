...
#define PLUMA_DOCUMENT_LOADER(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PLUMA_TYPE_DOCUMENT_LOADER, \
                              PlumaDocumentLoader))
#define PLUMA_DOCUMENT_LOADER_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), PLUMA_TYPE_DOCUMENT_LOADER, \
                           PlumaDocumentLoaderClass))
#define PLUMA_IS_DOCUMENT_LOADER(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), PLUMA_TYPE_DOCUMENT_LOADER))
#define PLUMA_IS_DOCUMENT_LOADER_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), PLUMA_TYPE_DOCUMENT_LOADER))
#define PLUMA_DOCUMENT_LOADER_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), PLUMA_TYPE_DOCUMENT_LOADER, \
                             PlumaDocumentLoaderClass))
...
struct _PlumaDocumentLoaderClass {
  ...
  /* Signals */
  void (*loading)(PlumaDocumentLoader *loader, gboolean completed,
                  const GError *error);
};
