...
#define PLUMA_NOTEBOOK(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), PLUMA_TYPE_NOTEBOOK, PlumaNotebook))
#define PLUMA_NOTEBOOK_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), PLUMA_TYPE_NOTEBOOK, PlumaNotebookClass))
#define PLUMA_IS_NOTEBOOK(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), PLUMA_TYPE_NOTEBOOK))
#define PLUMA_IS_NOTEBOOK_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), PLUMA_TYPE_NOTEBOOK))
#define PLUMA_NOTEBOOK_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), PLUMA_TYPE_NOTEBOOK, PlumaNotebookClass))
...
struct _PlumaNotebookClass {
  ...
  /* Signals */
  void (*tab_added)(PlumaNotebook *notebook, PlumaTab *tab);
  void (*tab_removed)(PlumaNotebook *notebook, PlumaTab *tab);
  void (*tab_detached)(PlumaNotebook *notebook, PlumaTab *tab);
  void (*tabs_reordered)(PlumaNotebook *notebook);
  void (*tab_close_request)(PlumaNotebook *notebook, PlumaTab *tab);
};
